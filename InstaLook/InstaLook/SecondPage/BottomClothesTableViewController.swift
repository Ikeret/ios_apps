//
//  BottomClothesTableViewController.swift
//  InstaLook
//
...
class BottomClothesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageCell.image = bottomImages[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            deleteImage(fileName: bottomImagesNames[indexPath.row])
            bottomImagesNames.remove(at: indexPath.row)
            SPAlert.present(title: NSLocalizedString("Deleted", comment: ""), preset: .done)
            
            bottomImages.remove(at: indexPath.row)
...
extension BottomClothesTableViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        DispatchQueue.main.async {
            bottomImagesNames.append(saveImage(image: selectedImage)!)
        }
        bottomImages.append(selectedImage)
